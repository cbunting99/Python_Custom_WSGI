...
class TestSSLUtils(unittest.TestCase):
    ...
    def test_security_options(self):
        ...
        self.assertTrue(
            context.check_hostname, "Hostname verification should be enabled"
        )
    ...
    def test_custom_cipher_suite(self):
        ...
        context = create_ssl_context(
            self.certfile, self.keyfile, ciphers=custom_ciphers
        )
    ...
    def test_password_protected_key(self):
        ...
        context = create_ssl_context(self.certfile, self.keyfile, password="unused")
        self.assertIsInstance(context, ssl.SSLContext)
